#!/usr/bin/env python3
"""Genera reporte HTML para topologia hub-spoke con CIDR alternativo (10.99.88.0/24) y 4 nubes/vm + 3 QEMU."""
...
REPORT_PATH = ROOT / "docs" / "reports" / "10.99.88.0_alt" / "hub-spoke" / "latest.html"
...
<body>
<h1>Reporte Hub-Spoke \u2014 CIDR """ + ALT_CIDR + """ \u2014 LinkGuard v2</h1>
...
def main() -> int:
    ...
    if args.output == str(REPORT_PATH):
        ...
        output_path = ROOT / "docs" / "reports" / "10.99.88.0_alt" / "hub-spoke" / date_dir / f"reporte-hubspoke-cidr{CIDR_SLUG}-{ts_slug}.html"
    else:
