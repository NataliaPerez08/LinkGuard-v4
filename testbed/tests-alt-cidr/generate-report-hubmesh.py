#!/usr/bin/env python3
"""Genera reporte HTML para topologia hub-mesh con CIDR alternativo (10.99.88.0/24) y 4 nubes/vm + 3 QEMU."""
...
REPORT_PATH = ROOT / "docs" / "reports" / "10.99.88.0_alt" / "hub-mesh" / "latest.html"
...
<title>Reporte Hub-Mesh \u2014 CIDR """ + ALT_CIDR + """ \u2014 LinkGuard v2</title>
<style>
...
<body>
<h1>Reporte Hub-Mesh \u2014 CIDR """ + ALT_CIDR + """ \u2014 LinkGuard v2</h1>
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Genera reporte HTML para topologia hub-mesh (4 nubes/vm + 3 QEMU)")
    ...
    if args.output == str(REPORT_PATH):
        ...
        output_path = ROOT / "docs" / "reports" / "10.99.88.0_alt" / "hub-mesh" / date_dir / f"reporte-hubmesh-cidr{CIDR_SLUG}-{ts_slug}.html"
    else:
