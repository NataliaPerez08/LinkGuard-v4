#!/usr/bin/env python3
"""Genera reporte HTML para topologia hub-mesh con 4 nubes + 3 QEMU (terminal nueva 172.20.0.40 via jump-host)."""
...
REPORT_PATH = ROOT / "docs" / "reporte-hubmesh-expanded.html"
...
<title>Reporte Hub-Mesh Expandido \u2014 LinkGuard v2</title>
<style>
...
<body>
<h1>Reporte Hub-Mesh Expandido \u2014 LinkGuard v2</h1>
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Genera reporte HTML para topologia hub-mesh (expandido: 4 nube/vm + 3 QEMU)")
    ...
    if args.output == str(REPORT_PATH):
        output_path = ROOT / "docs" / f"reporte-hubmesh-expanded-{ts_slug}.html"
    else:
