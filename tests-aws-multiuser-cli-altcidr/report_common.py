#!/usr/bin/env python3
"""Modulo comun para tests AWS Multiusuario CLI con CIDR alternativo.
    ...
    if alt_cidr:
        ...
        for r in results:
            ...
            if failed:
                ...
                if dst_qemu:
                    rows.append('<p><b>Fallos hacia QEMU \u2014 NAT simetrico:</b> Los QEMU estan detras del host local con NAT de puerto dinamico. El hub conoce el endpoint NAT del QEMU, pero al iniciar handshake el NAT asigna un puerto diferente y el QEMU nunca recibe el paquete.</p>')
...
def write_jsonl_report(timestamp: str, results: list[TopologyResult], alt_cidr: bool = False) -> None:
    filename = "aws-multiuser-cli-altcidr-historial.jsonl" if alt_cidr else "aws-multiuser-cli-altcidr-historial.jsonl"
...
def run_report(topology: str, *, title: str, report_subdir: str, file_prefix: str, default_topology: str = "hub-spoke", description: str = "") -> int:
    ...
    if args.output:
        ...
        base_dir = "aws-multiuser-cli-altcidr"
