#!/usr/bin/env python3
"""Genera reporte HTML para topologia hub-mesh con 4 nubes/vm + 3 QEMU."""
...
REPORT_PATH = ROOT / "docs" / "reports" / "10.20.30.0_default" / "hub-mesh" / "latest.html"
...
<title>Reporte Hub-Mesh \u2014 LinkGuard v2</title>
<style>
...
<body>
<h1>Reporte Hub-Mesh \u2014 LinkGuard v2</h1>
...
def main() -> int:
    ...
    if args.output == str(REPORT_PATH):
        ...
        output_path = ROOT / "docs" / "reports" / "10.20.30.0_default" / "hub-mesh" / date_dir / f"reporte-hubmesh-{ts_slug}.html"
    else:
