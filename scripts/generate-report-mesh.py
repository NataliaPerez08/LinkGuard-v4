#!/usr/bin/env python3
"""Genera reporte HTML para topologia mesh con 4 nubes/vm + 3 QEMU."""
...
REPORT_PATH = ROOT / "docs" / "reports" / "10.20.30.0_default" / "mesh" / "latest.html"
...
<title>Reporte Mesh \u2014 LinkGuard v2</title>
<style>
...
<body>
<h1>Reporte Mesh \u2014 LinkGuard v2</h1>
...
def main() -> int:
    ...
    if args.output == str(REPORT_PATH):
        ...
        output_path = ROOT / "docs" / "reports" / "10.20.30.0_default" / "mesh" / date_dir / f"reporte-mesh-{ts_slug}.html"
    else:
