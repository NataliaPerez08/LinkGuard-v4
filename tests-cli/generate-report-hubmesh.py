#!/usr/bin/env python3
"""Genera reporte HTML para topologia hub-mesh via CLI (orch-cli.py)."""
...
REPORT_PATH = ROOT / "docs" / "reports" / "cli" / "hub-mesh" / "latest.html"
...
<title>Reporte Hub-Mesh vía CLI \u2014 LinkGuard v2</title>
<style>
...
<body>
<h1>Reporte Hub-Mesh vía CLI \u2014 LinkGuard v2</h1>
...
def main() -> int:
    ...
    if args.output == str(REPORT_PATH):
        ...
        output_path = ROOT / "docs" / "reports" / "cli" / "hub-mesh" / date_dir / f"reporte-hubmesh-{ts_slug}.html"
    else:
