#!/usr/bin/env python3
"""Genera reporte HTML para topologia mesh via CLI (orch-cli.py)."""
...
<title>Reporte Mesh vía CLI \u2014 LinkGuard v2</title>
<style>
...
<body>
<h1>Reporte Mesh vía CLI \u2014 LinkGuard v2</h1>
...
def main() -> int:
    ...
    if args.output == str(REPORT_PATH):
        ...
        output_path = ROOT / "docs" / "reports" / "cli" / "hub-spoke" / date_dir / f"reporte-mesh-{ts_slug}.html"
    else:
