#!/usr/bin/env python3
"""Genera reporte HTML via CLI con 2 usuarios (admin + tenant)."""
...
REPORT_PATH = ROOT / "docs" / "reports" / "cli-multiuser-altcidr" / "hub-mesh" / "latest.html"
...
<title>Reporte Hub-Mesh CIDR """ + ALT_CIDR + """ CLI Multiuser — LinkGuard v2</title> \u2014 LinkGuard v2</title>
<style>
...
<body>
<h1>Reporte Hub-Mesh CIDR """ + ALT_CIDR + """ CLI Multiuser \u2014 LinkGuard v2</h1>
...
def main() -> int:
    ...
    if args.output == str(REPORT_PATH):
        ...
        output_path = ROOT / "docs" / "reports" / "cli-multiuser-altcidr" / "hub-mesh" / date_dir / f"v2-reporte-hubmesh-{ts_slug}.html"
    else:
