...
REPORT_PATH = ROOT / "docs" / "reports" / "cli-multiuser-altcidr" / "mesh" / "latest.html"
...
<title>Reporte Mesh CIDR """ + ALT_CIDR + """ CLI Multiuser — LinkGuard v2</title> \u2014 LinkGuard v2</title>
<style>
...
<body>
<h1>Reporte Mesh CIDR """ + ALT_CIDR + """ CLI Multiuser \u2014 LinkGuard v2</h1>
...
def main() -> int:
    ...
    if args.output == str(REPORT_PATH):
        ...
        output_path = ROOT / "docs" / "reports" / "cli-multiuser-altcidr" / "mesh" / date_dir / f"v2-reporte-mesh-{ts_slug}.html"
    else:
