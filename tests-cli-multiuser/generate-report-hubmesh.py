...
REPORT_PATH = ROOT / "docs" / "reports" / "cli-multiuser" / "hub-mesh" / "latest.html"
...
def main() -> int:
    ...
    if args.output == str(REPORT_PATH):
        ...
        output_path = ROOT / "docs" / "reports" / "cli-multiuser" / "hub-mesh" / date_dir / f"v2-reporte-hubmesh-{ts_slug}.html"
    else:
